...
\documentclass{llncs}
    ...
    \usepackage{amsmath,epsfig,amsfonts,amssymb,graphicx}
    ...
    %                                     \toctitle is used
    %
    \author{JinJing Huang\inst{1} \and Jiapeng Li\inst{1} \and
    Yanjuan Zhang\inst{1} \and Lei Zhao\inst{1}}
    %
    \authorrunning{JinJing Huang et al.} % abbreviated author list (for running head)
    %
    %%%% list of authors for the TOC (use if author list has to be modified)
    \tocauthor{JinJing Huang, Jiapeng Li, Yanjuan Zhang, Lei Zhao}
    %
    \institute{Soochow University, China,\\
            \email{trajepl@gmail.com, trajepl@gmail.com}}
